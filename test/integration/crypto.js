...
describe('fabcoinjs-lib (crypto)', function () {
  it('can recover a private key from duplicate R values', function () {
    ...
    const tx = fabcoin.Transaction.fromHex('')

    tx.ins.forEach(function (input, vin) {
      const { output: prevOutput, pubkey, signature } = fabcoin.payments.p2pkh({ input: input.script })

      const scriptSignature = fabcoin.script.signature.decode(signature)
      const m = tx.hashForSignature(vin, prevOutput, scriptSignature.hashType)
      assert(fabcoin.ECPair.fromPublicKey(pubkey).verify(m, scriptSignature.signature), 'Invalid m')
