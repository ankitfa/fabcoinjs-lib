...
describe('fabcoinjs-lib (BIP32)', function () {
  it('can import a BIP32 testnet xpriv and export to WIF', function () {
    ...
    const node = bip32.fromBase58(xpriv, fabcoin.networks.testnet)
  ...
  it('can create a BIP32, fabcoin, account 0, external address', function () {
    const path = "m/0'/0/0"
  ...
  it('can create a BIP44, fabcoin, account 0, external address', function () {
    const root = bip32.fromSeed(Buffer.from('dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd', 'hex'))
  ...
  it('can create a BIP49, fabcoin testnet, account 0, external address', function () {
    ...
    const { address } = fabcoin.payments.p2sh({
      redeem: fabcoin.payments.p2wpkh({ pubkey: child.publicKey, network: fabcoin.networks.testnet }),
